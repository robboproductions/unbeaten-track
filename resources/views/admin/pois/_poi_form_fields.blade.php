                ...
                @if ($poi)
                    ...
                    <div style="margin-top:12px;padding:12px 14px;border-radius:var(--radius-md);background:var(--color-river-stone);border:1px solid var(--color-border);">
                        ...
                        <p class="town-form-hint" style="margin-bottom:10px;">
                            Choose <strong>Baxter</strong> or <strong>Zoe</strong> when you generate; the POI stores which voice was used for the current file.
                        </p>
                        ...
                        <div style="margin-top:12px;display:flex;flex-wrap:wrap;gap:8px;align-items:center;">
                            @if ($poiNarration['enabled'] && $poiNarration['configured'] && filled($poi->narration_script))
                                <button
                                    ...
                                    form="ut-poi-narration-generate-baxter-{{ $poi->id }}"
                                >{{ $poi->has_narration ? 'Regenerate audio with Baxter' : 'Generate audio with Baxter' }}</button>
                                <button
                                    type="submit"
                                    class="btn btn-primary btn-sm"
                                    form="ut-poi-narration-generate-zoe-{{ $poi->id }}"
                                >{{ $poi->has_narration ? 'Regenerate audio with Zoe' : 'Generate audio with Zoe' }}</button>
