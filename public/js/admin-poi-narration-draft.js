/**
 * POI narration script: Draft Script with Claude.
 * Expects window.__UT_POI_NARRATION_DRAFT before this file loads.
 */
(function () {
    'use strict';

    function aiCfg() {
        var cfg = window.__UT_POI_NARRATION_DRAFT || {};
        return cfg.ai || {};
    }
    ...
    function setMessage(text, isError) {
        var el = document.getElementById('poi_narration_ai_message');
        if (!el) {
            return;
        }
        if (!text) {
    ...
    function boot() {
        var btn = document.getElementById('poi_narration_ai_btn');
        var ta = document.getElementById('poi_narration_script');
        var ai = aiCfg();
        if (!btn || !ta || !ai.url) {
            return;
        }
    ...
    if (document.getElementById('poi_narration_script')) {
        boot();
    }
})();
