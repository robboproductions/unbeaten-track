...
class PoiNarrationController extends Controller
{
    public function generate(Request $request, Poi $poi, PoiNarrationService $narration): RedirectResponse
    {
        ...
        $key = 'poi-narration:'.$request->user()->id;
        ...
        try {
            $narration->generate($poi->fresh(), $request->user());
    ...
    public function destroy(Poi $poi, PoiNarrationService $narration): RedirectResponse
    {
        $narration->deleteAudio($poi->fresh());
